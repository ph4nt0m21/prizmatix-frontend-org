...
const OrganizationProfile = ({ 
  ...
  const handleCropConfirm = (croppedImageUrl) => {
    setUploadedLogo({
      url: croppedImageUrl,
      name: selectedImage ? 'hard_rock_cafe_logo1.jpg' : 'uploaded_logo.jpg' // Default name or get from file
    });
  ...
  const handleAddSocialLink = () => {
    if (currentSocialPlatform && currentSocialUrl) {
      setSocialLinks([
        ...socialLinks,
        { platform: currentSocialPlatform, url: currentSocialUrl }
      ]);
        ...
        <div className={styles.formGroup}>
            ...
            <div className={styles.socialLinksContainer}>
              {socialLinks.map((link, index) => (
                <div key={index} className={styles.socialLinkItem}>
                  ...
                  <div className={styles.socialLinkUrl}>
                    {link.url}
                  </div>
                  <button 
                    type="button" 
          ...
          <div className={styles.socialLinksGrid}>
            <div className={styles.socialLinkRow}>
              <div className={styles.socialSelectContainer}>
                <button type="button" className={styles.socialSelectBtn}>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.cropModal}>
            <div className={styles.modalHeader}>
              <h3>Crop Image</h3>
              <button className={styles.closeModal} onClick={handleCropCancel}>×</button>
            </div>
            <div className={styles.cropContainer}>
              <img src={selectedImage} alt="Crop" className={styles.cropImage} />
            ...
            <div className={styles.cropControls}>
              <div className={styles.cropAspectRatios}>
              ...
              <div className={styles.cropActions}>
                ...
                <button 
                  ...
                  onClick={() => handleCropConfirm(selectedImage)}
                >
                  Upload
                </button>
              </div>
