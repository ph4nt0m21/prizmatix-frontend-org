...
const EventManageSidebar = ({
  ...
  const sections = [
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19.41 7.41L12 14.83L4.59 7.41L3.17 8.83L12 17.66L20.83 8.83L19.41 7.41ZM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill="currentColor"/>
        </svg>
      ),
      group: "manage",
    },
          ...
          {sections.filter(s => s.group === 'manage' && s.key !== 'tickets' && s.key !== 'discounts' && s.key !== 'eventPage').map((section) => {
            ...
            return (
              ...
              >
                ...
                {isCompleted && (
                  <div className={styles.sectionStatusIndicator}>
