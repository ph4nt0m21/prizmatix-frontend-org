...
const UploadIcon = (props) => (
  ...
  >
    <path
      d="M12 16.5V3M12 3L16.5 7.5M12 3L7.5 7.5"
      stroke="#4F46E5"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M21 12V19.5C21 20.3284 20.3284 21 19.5 21H4.5C3.67157 21 3 20.3284 3 19.5V12"
      stroke="#4F46E5"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const faqs = [
  {
    question: 'How do I create an event on Prizmatix?',
    answer:
      'You can create an event from your organiser dashboard by clicking “Create Event”. Fill in the event details, ticket types, and publish when ready.',
  },
  {
    question: 'How do I track ticket sales?',
    answer:
      "You can track ticket sales in real-time from the 'Reports' tab in your event management dashboard. It provides detailed analytics on revenue and attendance.",
  },
  {
    question: 'How do attendees get their tickets?',
    answer:
      'Attendees receive their tickets via email immediately after a successful purchase. They can also access them from their Prizmatix account.',
  },
  {
    question: 'How do I check in attendees at the event?',
    answer:
      'You can check in attendees using our mobile scanner app, available for organizers. Simply scan the QR code on their ticket.',
  },
  {
    question: 'What payment methods are supported?',
    answer:
      'We support a wide range of payment methods, including all major credit and debit cards, net banking, and popular digital wallets.',
  },
];

// --- Main Component ---
const HelpSupportModal = ({ isOpen, onClose }) => {
  const [view, setView] = useState('faq'); // 'faq' | 'contact' | 'success'
        ...
        {view === 'contact' && (
          <>
            ...
            <p className={styles.subHeader}>
              Tell us what went wrong and we'll get back to you soon.
            </p>
            ...
            >
              ...
              <div className={styles.formGroup}>
                ...
                >
                  <UploadIcon />
                  <span>
                    Upload anything related to your concern (.jpg, .pdf, .png)
                  </span>
                  <input
                    type="file"
                    id="attachments"
        ...
        {view === 'success' && (
          <div className={styles.successWrapper}>
            ...
            <div className={styles.successContent}>
              ...
              <p className={styles.successTitle}>Your email has been sent!</p>
